...
1 + \text{1|Borough:Neighborhood} + \text{1|Borough} + \\
\text{Room type} + \text{Minimum nights} + \text{Last review} + \\
\text{Host listings count} + \text{Non-zero avail.} + \text{Available days} +\\ 
\end{gathered}
$$

  * Observations with no reviews are excluded (`r round(sum(airbnb$reviews_per_month == 0)/nrow(airbnb), 2)*100`\% of the data)
...
### Limitations and Further Work
  ...
  * Missing data/latent space model for {\tt availability_365} 
