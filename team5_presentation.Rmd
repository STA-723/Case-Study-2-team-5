...
* NA's in monthly reviews: listings with no reviews
* NA's in last review dates: listings with no reviews
* Zero availablity but non-zero monthly reviews: temporary unavailability (shows plot)
...
>>>>>>> ca85d3b67b1d18ac88da8a880ecbaa27954e004d
...
![price](figures/map_log_price.png) ![rpm](figures/map_log_rpm.png)
...
* The most influential factors for popularity include: last review, availability, minimum nights, price, etc.
...
![Manhattan](figures/wordcloud_manhattan.png) ![Brooklyn](figures/wordcloud_brooklyn.png) ![Queens](figures/wordcloud_queens.png)
