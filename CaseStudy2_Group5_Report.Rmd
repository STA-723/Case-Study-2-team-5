...
## 1. Introduction
Airbnb New York City Open Data collected in 2019 contains information of 48,895 Airbnb listings in New York. The dataset has 16 variables, including listing name, location, price, number of reviews, room type, etc. The analysis focuses on identifying interesting patterns among airbnb listings, especially the influential factors for price and popularity.
